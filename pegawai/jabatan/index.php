...
<html lang="en">
	...
	function del_data(id, nama) {
	  swal({
	      ...
	      text: "Yakin Ingin Hapus Jabatan '"+nama+"'?",
	      type: "warning",
	      ...
	      function(){
	        $.ajax({
	            url: host+'/pegawai/jabatan/CRUD_jabatan.php',
	            type: 'POST',
	            dataType: 'html',
	            data: 'delete='+id,
	            beforeSend: function() {
	            ...
	            success: function(hasil) {
	              if (hasil == "Sukses") {
	                  swal({
	                      title: "Sukses!",
	                      text: "Hapus jabatan '"+nama+"' berhasil!",
	                      type: "success",
	                ...
	                swal("Gagal!", "Hapus jabatan '"+nama+"' gagal! Pastikan tidak ada data pegawai yang menggunakan data jabatan '"+nama+"'", "error");
	              }
	            },
	...
	function edit_data(id) {
		$.ajax({
			url: host+'/pegawai/jabatan/edit-detail.php',
			type: 'POST',
			data: 'id='+id,
			beforeSend: function() {
