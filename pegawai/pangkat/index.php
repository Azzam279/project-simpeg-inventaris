...
<html lang="en">
	...
	function del_data(id, nama) {
	  swal({
	      ...
	      text: "Yakin Ingin Hapus Pangkat '"+nama+"'?",
	      type: "warning",
	      ...
	      function(){
	        $.ajax({
	            url: host+'/pegawai/pangkat/CRUD_pangkat.php',
	            type: 'POST',
	            dataType: 'html',
	            data: 'delete='+id,
	            beforeSend: function() {
	            ...
	            success: function(hasil) {
	              if (hasil == "Sukses") {
	                  swal({
	                      title: "Sukses!",
	                      text: "Hapus pangkat '"+nama+"' berhasil!",
	                      type: "success",
	                ...
	                swal("Gagal!", "Hapus pangkat '"+nama+"' gagal! Pastikan tidak ada data pegawai yang menggunakan data pangkat '"+nama+"'", "error");
	              }
	            },
	...
	function edit_data(id) {
		$.ajax({
			url: host+'/pegawai/pangkat/edit-detail.php',
			type: 'POST',
			data: 'id='+id,
			beforeSend: function() {
