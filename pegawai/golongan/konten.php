	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="formModalLabel">Form Input Golongan</h4>
			</div>
			<div id="show-alert"></div>
			<form class="form-horizontal" action="<?=htmlspecialchars("CRUD_golongan.php")?>" method="post" role="form" id="form-input">
				<div class="modal-body">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="golongan" id="golongan" class="form-control" placeholder="Nama Golongan" required="" maxlength="50">
						</div>
					</div>
				</div>
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" action="<?=htmlspecialchars("CRUD_golongan.php")?>" method="post" role="form" id="form-edit">
