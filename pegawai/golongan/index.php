...
<html lang="en">
	...
	function del_data(id, nama) {
	  swal({
	      ...
	      text: "Yakin Ingin Hapus Golongan '"+nama+"'?",
	      type: "warning",
	      ...
	      function(){
	        $.ajax({
	            url: host+'/pegawai/golongan/CRUD_golongan.php',
	            type: 'POST',
	            dataType: 'html',
	            data: 'delete='+id,
	            beforeSend: function() {
	            ...
	            success: function(hasil) {
	              if (hasil == "Sukses") {
	                  swal({
	                      title: "Sukses!",
	                      text: "Hapus golongan '"+nama+"' berhasil!",
	                      type: "success",
	                ...
	                swal("Gagal!", "Hapus golongan '"+nama+"' gagal! Pastikan tidak ada data pegawai yang menggunakan data golongan '"+nama+"'", "error");
	              }
	            },
	...
	function edit_data(id) {
		$.ajax({
			url: host+'/pegawai/golongan/edit-detail.php',
			type: 'POST',
			data: 'id='+id,
			beforeSend: function() {
