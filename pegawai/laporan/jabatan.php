...
<head>
	<meta charset="UTF-8">
	<title>Laporan Pegawai Berdasarkan Jabatan</title>
	<?php include_once("css.php"); ?>
</head>
<body onload="window.print()">
	<header>
		<h3>DAFTAR NOMINATIF PEGAWAI BERDASARKAN JABATAN<br>SEKRETARIAT DAERAH PROV. KALSEL TAHUN 2016</h3>
	</header>
	<br>
