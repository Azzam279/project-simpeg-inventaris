...
<head>
	<meta charset="UTF-8">
	<title>Laporan Pegawai Berdasarkan Unit Kerja</title>
	<?php include_once("css.php"); ?>
</head>
<body onload="window.print()">
	<header>
		<h3>DAFTAR NOMINATIF PEGAWAI BERDASARKAN UNIT KERJA<br>SEKRETARIAT DAERAH PROV. KALSEL TAHUN 2016</h3>
	</header>
	<br>
