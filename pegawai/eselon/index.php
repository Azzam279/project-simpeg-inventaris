...
<html lang="en">
	...
	<div class="modal fade in slacker-modal-ese slacker-pegawai" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="false">
	...
	function del_data(id, nama) {
	  swal({
	      ...
	      text: "Yakin Ingin Hapus Eselon '"+nama+"'?",
	      type: "warning",
	      ...
	      function(){
	        $.ajax({
	            url: host+'/pegawai/eselon/CRUD_eselon.php',
	            type: 'POST',
	            dataType: 'html',
	            data: 'delete='+id,
	            beforeSend: function() {
	            ...
	            success: function(hasil) {
	              if (hasil == "Sukses") {
	                  swal({
	                      title: "Sukses!",
	                      text: "Hapus eselon '"+nama+"' berhasil!",
	                      type: "success",
	                ...
	                swal("Gagal!", "Hapus eselon '"+nama+"' gagal! Pastikan tidak ada data pegawai yang menggunakan data eselon '"+nama+"'", "error");
	              }
	            },
	...
	function edit_data(id) {
		$.ajax({
			url: host+'/pegawai/eselon/edit-detail.php',
			type: 'POST',
			data: 'id='+id,
			beforeSend: function() {
