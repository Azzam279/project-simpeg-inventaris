	...
	<article>
		<div class="row" style="font-size: 11px;">
			<div class="col-xs-6 col-xs-offset-6">
				<center>Banjarbaru, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?=indo_date($cuti->tgl_surat)?></center>
			</div>
		</div>
		<div class="row" style="font-size: 11px;">
			<div class="col-xs-6">
			...
			<div class="col-xs-6">
				<b>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kepada <br>
					Yth. Gubernur Kalimantan Selatan <br>
			        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Up. Kepala Badan Kepegawaian Daerah <br>
		...
		<div class="row" style="font-size: 11px;">
			<div class="col-xs-10 col-xs-offset-2">
				...
				<br>
				<p align="justify">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dengan  ini  mengajukan Cuti Tahunan untuk Tahun <?=date('Y')?>  Tahap II selama <?=$cuti->hari?> hari   terhitung  mulai   <?=indo_date($cuti->tgl_mulai)?> s.d <?=indo_date($cuti->tgl_selesai)?> . Selama menjalankan cuti tersebut alamat di <?=$cuti->alamat?>.
				</p>
