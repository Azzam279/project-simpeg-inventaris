				...
				<div class="card-body">
					<div class="row">
						<div class="col-sm-12">
							...
							<form class="form" action="<?=htmlspecialchars("proses-login-admin.php")?>" accept-charset="utf-8" method="post" id="form-login">
								<div class="form-group floating-label">
									<div class="input-group">
										<div class="input-group-content">
											<input type="text" id="username" class="form-control" name="user" maxlength="50">
